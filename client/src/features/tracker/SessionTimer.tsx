...
function SessionTimer() {
   ...
   return (
    <div className={`${style.container} w-full min-w-0 max-w-md h-auto border-2 border-[#2A2A2A] flex flex-row justify-between items-center rounded-md min-h-24 pl-3`}>      
