...
function MenuDropdown({ toggleMenu, menuOpen, toggleDeleteAccountPopup }: MenuDropdownTypes) {
  ...
  return (
    <div className={`${menuOpen ? 'pointer-events-auto' : 'pointer-events-none'} lg:hidden fixed inset-0 z-800`}>
      ...
      <div className={`relative mx-4 mt-20 overflow-hidden rounded-[28px] border border-white/10 bg-[#090909]/95 shadow-[0_40px_120px_-30px_rgba(0,0,0,0.8)] transition-all duration-200 ${menuOpen ? 'translate-y-0 opacity-100' : '-translate-y-2.5 opacity-0'}`}>
